    ...
    return (
        <section className="max-w-7xl mx-auto px-6 py-16 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-lg flex flex-col md:flex-row gap-12">
            ...
            <div className="flex-1 flex flex-col justify-center space-y-6">
                ...
                {/* Contact Button */}
                <button className="inline-block max-w-max px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium rounded-lg shadow hover:shadow-lg hover:brightness-110 transition duration-300">
                    Contact Me
                </button>
